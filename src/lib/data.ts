...
export const projectCategories: ProjectCategory[] = ['Residential', 'Commercial', 'Government', 'Infrastructure'];
...
export const projects: Project[] = [
  {
    ...
    details: {
      ...
      duration: '12 Months',
      services: ['Architectural & Structural Design', 'General Contracting', 'Finishing & Interior Works'],
    },
    gallery: [
  ...
  },
  {
    ...
    details: {
      client: 'Alpha Corp',
      duration: '36 Months',
      services: ['General Contracting', 'Infrastructure Works'],
    },
     gallery: [
  ...
  },
  {
    ...
    details: {
      ...
      duration: '18 Months',
      services: ['Renovation & Maintenance', 'Finishing & Interior Works'],
    },
     gallery: [
  ...
  },
  {
    ...
    details: {
      ...
      duration: '20 Months',
      services: ['General Contracting', 'Architectural & Structural Design'],
    },
     gallery: [
    ...
    details: {
      client: 'Innovate Inc.',
      duration: '22 Months',
      services: ['General Contracting', 'Finishing & Interior Works'],
    },
     gallery: [
